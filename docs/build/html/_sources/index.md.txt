...
內部提供的類，詳盡説明，請參見源代碼當中的註釋
- - atomic_int/原子有符號整數
- - atomic_uint/原子無符號整數
- - atomic_float/原子浮點數
- - atomic_bool/原子布爾型
- - atomic_bytearray/原子字節數組
- - atomic_string/原子字符串
- - atomic_set/原子集合, 需要安裝 [bitarray>=2.4.0](https://pypi.org/project/bitarray/).
- - atomic_list/原子列表, 需要安裝 [bitarray>=2.4.0](https://pypi.org/project/bitarray/).
