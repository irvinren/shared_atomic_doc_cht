...
1) 創建子進程所需要的函數, 參考 [原子無符號整數API](./原子無符號整數API.md), [原子有符號整數API](./原子有符號整數API.md), [原子字節數組API](./原子字節數組API.md), [原子字符串API](./原子字符串API.md), [原子集合API](./原子集合API.md), [原子列表API](./原子列表API.md), 子進程當中可以創建多線程.
